...
<%
			if (request.getParameter("btn") != null) {
				...
				String comp = request.getParameter("comp").replace(' ', '-');
				String  phone = request.getParameter("phone");
				Client client = Client.create();
				
				WebResource webResource = client.resource("http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/Complaints/"+name+"/"+surname+"/"+phone+"/"+comp);
	...
	<h1>Custmoer's Complaints</h1>
	<form METHOD="POST">
		Name: <input type="text" name="name" value="" required><br> <br>
		Surname: <input type="text" name="surname" value="" required><br> <br>
		Phone Number: <input type="tel" name="phone" placeholder="69-12345678" pattern="[6][9]-[0-9]{8}" required><br><br>
		Complaint:<input type="text" name="comp" value="" required><br> <br>
