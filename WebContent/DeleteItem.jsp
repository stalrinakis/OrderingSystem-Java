...
<%
			if (request.getParameter("btn") != null) {
				...
				WebResource webResource = client.resource("http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/DeleteItem/"+name);
	...
	<h1>Delete Item</h1>
	<form METHOD="POST">
		<h2>Item to search and delete:</h2>
		Name: <input type="search" name="name" value="" required><br> <br>
