...
<%
			if (request.getParameter("btn") != null) {
				String email = request.getParameter("ex_email");

				
				
				Client client = Client.create();
				
				WebResource webResource = client.resource("http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/DeleteUser/"+email);
	...
	<h1>Delete User</h1>
	<form METHOD="POST">
		<h2>User to find and delete:</h2>
		Email: <input type="email" id="ex_email" name="ex_email" required><br> <br>
