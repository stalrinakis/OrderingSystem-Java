...
<%
			if (request.getParameter("btn") != null) {
				...
				WebResource webResource = client.resource("http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/Orders/"+name+"/"+num);
	...
	<h1>Orders from main storage</h1>
	<form METHOD="POST">
		<h2>Item to order:</h2>
		Name: <input type="text" name="name" value="" required><br> <br>
		Quantity: <input type="number" name="num" min="0" required><br> <br>
