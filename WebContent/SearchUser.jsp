...
<%
			if (request.getParameter("btn") != null) {
				...
				WebResource webResource = client.resource("http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/SearchUser/"+email);
	...
	<form METHOD="POST">
		<h2>User to find: </h2>
		Email: <input type="email" id="email" name="ex_email" required><br> <br>
