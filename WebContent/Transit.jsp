...
<body>
	...
	<%
		...
		"http://localhost:8080/WebOrderingSystem/rest/OrderingSystem/Transit/" + name + "/" + num + "/" + store);
	...
	<form METHOD="POST">
		...
		<br> Quantity: <input type="number" name="num" min="0" required><br>
		<br> Store: <input type="radio" name="store" value="A" required><label>Store
			A</label> <input type="radio" name="store" value="B" required><label>Store
			B</label> <input type="radio" name="store" value="C" required><label>Store
			C</label><br> <br> <input type="submit" name="btn" value="Submit">
	</form>
